...
// TODO(ads-disabled-018): app-open ad + gatekeeper sync removed
...
class _GlowyAppState extends State<GlowyApp> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    // TODO(ads-disabled-018): app-open ad on resume removed
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) => MultiBlocProvider(
        ...
        child: BlocListener<SubscriptionCubit, SubscriptionState>(
          // TODO(ads-disabled-018): gatekeeper sync removed — no ad manager
          // left to read it.
